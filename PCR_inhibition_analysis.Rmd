...
inhtox<-read.csv(file="?";",header=T,dec=".")
...
dxtox<-read.csv(file="?",sep=";",header=T,dec=".")
...
fbctox<-read.csv(file="?",sep=";",header=T,dec=".")
...
cyt_man<-read.csv(file="?",sep=";",header=T,dec=".")
...
inhpj<-read.csv(file="?",sep=";",header=T,dec=".")
...
dxpj<-read.csv(file="?",sep=";",header=T,dec=".")
